          ...
          <div style={{ position:'relative', zIndex:1, padding:'48px 56px', display:'flex', gap:48, alignItems:'center', flexWrap:'wrap' }}>
            ...
            <div style={{ flex:'1 1 300px' }}>
              ...
              <h1 style={{ fontFamily:"'Playfair Display',serif", fontSize:36, fontWeight:800, color:'#fff', margin:'0 0 16px', lineHeight:1.22 }}>
                Ace your next<br/>
                <span style={{ background:`linear-gradient(90deg,${t.accent},${t.teal})`, WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>interview & GD</span>
              </h1>
            ...
            <div style={{ flex:'1 1 240px', display:'flex', flexDirection:'column', gap:12 }}>
              {[
                ...
                <div key={label} style={{ display:'flex', alignItems:'center', gap:12, padding:'12px 16px', borderRadius:14, background:'rgba(255,255,255,0.06)', border:'1px solid rgba(255,255,255,0.1)', backdropFilter:'blur(8px)' }}>
                  ...
                  <span style={{ fontSize:13, fontWeight:600, color:'rgba(255,255,255,0.82)', fontFamily:f }}>{label}</span>
                </div>
              ))}
            </div>
          </div>
